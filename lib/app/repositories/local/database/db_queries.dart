...
const SCRIPT_CREATE_TABLE_PURCHASE_SQL =
    ...
    "$TABLE_PURCHASE_ATT_ID INTEGER NOT NULL,"
    ...
    "$TABLE_PURCHASE_ATT_TOTAL_VALUE TEXT,"
    "$TABLE_PURCHASE_ATT_AMOUNT_ITEMS TEXT,"
    "$TABLE_PURCHASE_ATT_IS_DELETED INTEGER,"
    "PRIMARY KEY($TABLE_PURCHASE_ATT_ID),"
